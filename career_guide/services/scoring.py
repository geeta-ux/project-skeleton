# career_guide/services/scoring.py
import numpy as np
...
def compute_raw_scores(responses):
    ...
    for r in responses:
        ...
        section_scores.setdefault(section, []).append(r.score)
...
def calculate_scores(user_id, assessment_id, method="minmax"):
    ...
    result = Result(user_id=user_id, assessment_id=assessment_id, scores=normalized)
